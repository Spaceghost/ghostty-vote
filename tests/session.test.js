...
test('return paths: only the vote page (or its admin page) on this site', () => {
  ...
  for (const mini of ['/mods/ffxiv/term/', '/mods/ffxiv/xivmcp/', '/mods/ffxiv/xivdesktop/', '/mods/ffxiv/xivarcade/', '/mods/ffxiv/xivwayfinder/', '/mods/ffxiv/xivlantern/', '/mods/ffxiv/xivpiano/', '/mods/ffxiv/almanac/about/']) assert.equal(safeReturnPath(mini), mini);
