...
test('public/ holds only the site, at its real URL paths', () => {
  ...
  assert.deepEqual(walk('public/').filter((f) => !isMediaFile(f)).sort(), [
    ...
    'mods/ffxiv/site/art/almanac-banner-2.webp',
    'mods/ffxiv/site/art/almanac-icon-2.webp',
    'mods/ffxiv/site/art/ghostty-banner.webp',
    'mods/ffxiv/site/art/ghostty-icon.webp',
    'mods/ffxiv/site/art/xivarcade-banner-2.webp',
    'mods/ffxiv/site/art/xivarcade-icon-2.webp',
    'mods/ffxiv/site/art/xivdesktop-banner-2.webp',
    'mods/ffxiv/site/art/xivdesktop-icon-2.webp',
    'mods/ffxiv/site/art/xivlantern-banner-2.webp',
